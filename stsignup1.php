...
<body>
  ...
  <body>
    ...
    <section class='login' id='login'>
        <br><br><br>
        <div class='head'>
        <h1 class='company'>Vignan's students</h1>
        </div>
        ...
        <input type="text" placeholder='Id number' class='text' id='id number' name="idnumber" required><br><br>
        <input type="text" placeholder='Branch' class='text' id='branch' name="branch" required><br><br>
        <input type="text" placeholder='Year' class='text' id='year'name="year" required><br><br>
        ...
        <input type="password" placeholder='conform password' class='password' name="conpos" required><br>
        <button class='btn-login' id='do-login' name="submit" value="signup">sign up</button>
