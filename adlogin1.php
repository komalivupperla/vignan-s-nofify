...
<body>
  ...
  <body>
    ...
    <section class='login' id='login'>
        ...
        <input type="password" placeholder='••••••••••••••' class='password' id="password" name="password" required><br>
        <button class="btn-login" value="login" name="submit">login</button>
        <a href="adsignup1.php" class='forgot'>Not at Sign in?</a>
